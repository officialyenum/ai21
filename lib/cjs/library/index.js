...
exports.useSummarize = exports.useSummarizeBody = exports.usePrompt = exports.useBody = exports.useHeaders = exports.SUMMARIZE_TEXT = exports.SummarizeType = void 0;
...
const useSummarizeBody = (data) => {
    if (data.type && data.type === SummarizeType.REVIEWS) {
        ...
        return (0, prompts_1.getReviewPrompt)(data.restaurant, data.review);
    }
    return {
        text: data.text,
    };
