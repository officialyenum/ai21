...
exports.getRestaurantReviewPrompt = exports.useRewrite = exports.useRewriteBody = exports.useSummarize = exports.useSummarizeBody = exports.usePrompt = exports.useBody = exports.useHeaders = exports.SUMMARIZE_TEXT = exports.RewriteType = exports.SummarizeType = void 0;
var SummarizeType;
...
const useRewriteBody = (data) => {
    ...
    return {
        text: data.text,
        intent: (_b = data.intent) !== null && _b !== void 0 ? _b : 'general'
    };
};
